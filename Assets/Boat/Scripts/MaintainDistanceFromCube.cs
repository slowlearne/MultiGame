...
public class MaintainDistanceFromCube : MonoBehaviour
{
    ...
    public void ShowTheInstantiatedOption()
    {
        ...
        item1.transform.position = new Vector3(-4.14f, 3f, player.position.z + 90f);
        item2.transform.position = new Vector3(5.42f, 3f, player.position.z + 90f);
