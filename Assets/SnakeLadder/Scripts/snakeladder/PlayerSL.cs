...
public class PlayerSL : MonoBehaviour
{
    ...
    public GameManagerSL gamemanagerobj;
  ...
  public IEnumerator MoveToTarget()
    ...
    public void isDiceInsamePosition()
    {
        ...
        PlayerSL[] players = new PlayerSL[] { diceRoller.redPlayer, diceRoller.bluePlayer, diceRoller.greenPlayer, diceRoller.yellowPlayer };
