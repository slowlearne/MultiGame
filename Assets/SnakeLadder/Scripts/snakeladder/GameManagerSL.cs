...
public class GameManagerSL : MonoBehaviour
{
    ...
    public IEnumerator startGame()
    {
        ...
        while (true)
        {
            ...
            if (count == 1)
            {
                player1.GetComponent<PlayerSL>().isPlayerTurn = true;
                player2.GetComponent<PlayerSL>().isPlayerTurn = false;
                player3.GetComponent<PlayerSL>().isPlayerTurn = false;
            ...
            {
                player1.GetComponent<PlayerSL>().isPlayerTurn = false;
                player2.GetComponent<PlayerSL>().isPlayerTurn = true;
                player3.GetComponent<PlayerSL>().isPlayerTurn = false;
                player4.GetComponent<PlayerSL>().isPlayerTurn = false;
            ...
            else if (count == 3)
            {
                player1.GetComponent<PlayerSL>().isPlayerTurn = false;
                player2.GetComponent<PlayerSL>().isPlayerTurn = false;
                player3.GetComponent<PlayerSL>().isPlayerTurn = true;
                player4.GetComponent<PlayerSL>().isPlayerTurn = false;
            ...
            else
            {
                ...
                player2.GetComponent<PlayerSL>().isPlayerTurn = false;
                player3.GetComponent<PlayerSL>().isPlayerTurn = false;
                player4.GetComponent<PlayerSL>().isPlayerTurn = true;
